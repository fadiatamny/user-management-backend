...
const models: TsoaRoute.Models = {
    ...
    "UserStatus": {
        "dataType": "refEnum",
        "enums": ["active","pending","blocked"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "UserPatchPayload": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{},"additionalProperties":{"ref":"UserStatus"},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/api/users/query',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.query)),

            async function UsersController_query(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    payload: {"in":"body","name":"payload","required":true,"ref":"QueryPayload"},
            };
        ...
        app.patch('/api/users',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    payload: {"in":"body","name":"payload","required":true,"ref":"UserPatchPayload"},
            };
